...
public class IEasyAnimatorControllerTest {
  ...
  public void nullConstructor() {
    try {
      new EasyAnimatorController(null, null, 30);
      fail();
  ...
  public void controlWithSVGView() {
    ...
    assertEquals(
        "<svg width=\"360\" height=\"360\" " +
                ...
                "<animate attributeType=\"xml\" begin=\"20.0ms\"" +
                " dur=\"1ms\" attributeName=\"visibility\" " +
                "from=\"hidden\" to=\"visible\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"200.0ms\" " +
                "dur=\"800.0ms\" attributeName=\"x\" from=\"0.0\"" +
                " to=\"100.0\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"200.0ms\"" +
                " dur=\"800.0ms\" attributeName=\"y\" from=\"130.0\" " +
                "to=\"230.0\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"1020.0ms\" " +
                "dur=\"380.0ms\" attributeName=\"width\" from=\"50.0\" " +
                "to=\"25.0\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"1400.0ms\" " +
                "dur=\"600.0ms\" attributeName=\"x\" " +
                "from=\"100.0\" to=\"0.0\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"1400.0ms\" " +
                "dur=\"600.0ms\" attributeName=\"y\" " +
                "from=\"230.0\" to=\"130.0\" fill=\"freeze\" />\n" +
                "</rect>\n<ellipse id=\"C\" cx=\"300.0\" cy=\"30.0\" " +
                "rx=\"60.0\" ry=\"30.0\" fill=\"rgb(0,0,255)\" visibility=\"hidden\" >\n" +
                "<animate attributeType=\"xml\" begin=\"120.0ms\" " +
                "dur=\"1ms\" attributeName=\"visibility\" from=\"hidden\" " +
                "to=\"visible\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"400.0ms\" " +
                "dur=\"600.0ms\" attributeName=\"cy\" from=\"30.0\" " +
                "to=\"210.0\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"1000.0ms\" " +
                "dur=\"400.0ms\" attributeName=\"cy\" from=\"210.0\"" +
                " to=\"330.0\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"1000.0ms\" " +
                "dur=\"400.0ms\" attributeName=\"fill\" " +
                "values=\"rgb(0,0,255);rgb(0,170,85)\" fill=\"freeze\" />\n" +
                "<animate attributeType=\"xml\" begin=\"1400.0ms\" " +
                "dur=\"200.0ms\" attributeName=\"fill\" " +
                "values=\"rgb(0,170,85);rgb(0,255,0)\" fill=\"freeze\" />\n" +
